              ...
              <Link to={service.id === 'study' ? '/study-abroad' : `/services/${service.id}`}>
                ...
                <div className="flex flex-col md:flex-row gap-6 items-start">
                   <div className="md:w-1/3">
                      ...
                      <h3 className="text-4xl font-serif italic leading-none group-hover:text-blue-900 transition-colors">
                        {service.title}
                      </h3>
                   </div>
      ...
      <section className="max-w-6xl mx-auto px-6 mt-40">
         <div className="bg-blue-900 p-16 md:p-24 flex flex-col items-center text-center space-y-10 relative overflow-hidden">
            ...
            <p className="text-blue-100/60 max-w-xl text-sm font-bold uppercase tracking-widest leading-loose relative z-10">
               Our bureau facilitates global mobility across 120+ territories. Contact our senior specialists for a bespoke profile assessment.
            </p>

            <button className="bg-white text-blue-900 px-12 py-6 text-[10px] font-black uppercase tracking-[0.4em] hover:bg-blue-50 transition-all relative z-10 shadow-2xl">
